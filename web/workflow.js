...
const plannerChat = { sessionId: 'planner-' + Math.random().toString(36).slice(2), messages: [], ready: null };
...
render = function (name) {
  ...
  if (current === 'assistant') bindAssistant();
